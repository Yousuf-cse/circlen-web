    ...
    <div style={{ position: "absolute", top: "50%", left: "50%" }}>
      <div
        ...
        style={{
          ...
          border: `1.5px solid ${friend.busted ? "var(--red)" : "rgba(255,255,255,0.1)"}`,
          display: "flex",
          alignItems: "center",
      ...
      >
        {friend.emoji}
        <div
          className={friend.status === "distract" ? "s-distract" : ""}
          style={{
            position: "absolute",
            bottom: -2,
            right: -2,
      ...
      <div
        ...
        style={{
          ...
          boxShadow:
            "0 20px 60px rgba(0,0,0,0.6),0 0 30px rgba(0,232,122,0.06)",
          fontSize: 11,
        ...
        >
          ...
          <span
            style={{
              ...
              color:
                friend.badge.type === "green"
                  ? "var(--green)"
                  : friend.badge.type === "red"
                    ? "var(--red)"
                    : "var(--muted2)",
              background:
                friend.badge.type === "green"
              ...
              border: `1px solid ${friend.badge.type === "green" ? "var(--border-green)" : friend.badge.type === "red" ? "rgba(255,69,45,0.2)" : "var(--border)"}`,
            }}
          >
            {friend.badge.label}
          </span>
        ...
        {friend.alert && (
          <div
            style={{
              ...
              fontFamily: "'DM Mono',monospace",
              color:
                friend.alert.type === "red" ? "var(--red)" : "var(--muted2)",
              background:
                friend.alert.type === "red"
                  ? "var(--red-dim)"
