    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle,rgba(255,69,69,0.05) 0%,transparent 70%)",
          top: "30%",
          left: "65%",
      ...
      />
      {[
        ["tl", "80px", "40px", "auto", "auto", "1px 0 0 1px"],
        ["tr", "80px", "auto", "auto", "40px", "1px 1px 0 0"],
        ["bl", "auto", "40px", "40px", "auto", "0 0 1px 1px"],
        ["br", "auto", "auto", "40px", "40px", "0 1px 1px 0"],
      ].map(([cls, top, left, bottom, right, bw]) => (
        <div
          key={cls}
          className={`hero-corner ${cls}`}
          style={{
            top,
      ...
      >
        We all got that friend who says, ‘Bro, I didn’t study anything’ and
        still gets 9+ CGPA.
        <br />
      ...
      >
        // No spam. Just a ping when we drop. 🔔
      </p>
    </section>
  );
}
