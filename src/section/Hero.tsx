...
export default function Hero() {
  ...
  return (
    <section style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: "120px 24px 80px", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 14, marginTop: 44, animation: "fadeUp 0.7s 0.36s ease both", position: "relative", zIndex: 3, flexWrap: "wrap", justifyContent: "center" }}>
        <div style={{ display: "flex", alignItems: "center", background: "var(--surface)", border: "1px solid var(--border)", borderRadius: 100, padding: "5px 5px 5px 20px", gap: 8, transition: "border-color 0.3s,box-shadow 0.3s" }}
        ...
        >
          <input id="heroEmail" type="email" placeholder="your@email.com" onKeyDown={e => e.key === "Enter" && handleJoin("heroEmail")}
            style={{ background: "transparent", border: "none", outline: "none", color: "var(--white)", fontFamily: "'DM Sans',sans-serif", fontSize: 14, width: 200 }} />
          <button onClick={() => handleJoin("heroEmail")}
            style={{ background: "var(--green)", color: "#000", border: "none", padding: "12px 24px", borderRadius: 100, fontFamily: "'DM Sans',sans-serif", fontSize: 14, fontWeight: 600, cursor: "none", transition: "all 0.25s", whiteSpace: "nowrap" }}
      ...
      <p style={{ fontSize: 12, color: "var(--green)", marginTop: 16, animation: "fadeUp 0.7s 0.48s ease both", position: "relative", zIndex: 3, fontFamily: "'DM Mono',monospace", letterSpacing: "0.04em" }}>{msg}</p>
      <p style={{ fontSize: 12, color: "var(--muted)", marginTop: msg ? 4 : 16, animation: "fadeUp 0.7s 0.48s ease both", position: "relative", zIndex: 3, fontFamily: "'DM Mono',monospace", letterSpacing: "0.04em" }}>// No spam. Just a ping when we drop. 🔔</p>
    </section>
  );
}