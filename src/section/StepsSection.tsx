...
export default function StepsSection() {
  ...
  const steps = [
    ...
    { num: "02", icon: "📚", title: "Start Studying", desc: "Declare your subject, hit start. The app silently watches which apps you're actually using." },
    { num: "03", icon: "💀", title: "Get Exposed", desc: "Your friends get notified. \"Rafi opened PUBG 6 times in the last hour — studying or gaslighting?\"" },
  ];
  return (
